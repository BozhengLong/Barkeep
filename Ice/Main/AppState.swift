...
final class AppState: ObservableObject {
    ...
    /// The watchdog that monitors private-API health.
    private(set) lazy var healthMonitor = HealthMonitor(appState: self)
    ...
    func performSetup() {
        CapabilityProbe.logReport()
        healthMonitor.performSetup()
