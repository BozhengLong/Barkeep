...
extension Bridging {
    ...
    static func getWindowFrame(for windowID: CGWindowID) -> CGRect? {
        ...
        guard result == .success else {
            ...
            BridgingHealth.shared.record("CGSGetScreenRectForWindow", detail: result.logString)
            return nil
        }
        return rect
    }
...
extension Bridging {
    ...
    private static func getWindowList() -> [CGWindowID] {
        ...
        guard result == .success else {
            ...
            BridgingHealth.shared.record("CGSGetWindowList", detail: result.logString)
            return []
        }
    ...
    private static func getOnScreenWindowList() -> [CGWindowID] {
        ...
        guard result == .success else {
            ...
            BridgingHealth.shared.record("CGSGetOnScreenWindowList", detail: result.logString)
            return []
        }
        return [CGWindowID](list[..<Int(realCount)])
    }
    ...
    private static func getMenuBarWindowList() -> [CGWindowID] {
        ...
        guard result == .success else {
            ...
            BridgingHealth.shared.record("CGSGetProcessMenuBarWindowList", detail: result.logString)
            return []
        }
        return [CGWindowID](list[..<Int(realCount)])
    }
