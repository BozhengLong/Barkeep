...
final class ControlItem {
    ...
    var windowID: CGWindowID? {
        ...
        // On macOS 26 the window number can be negative; `CGWindowID(Int)` would
        // trap. Fail gracefully instead (callers already handle a nil windowID).
        return CGWindowID(safeWindowNumber: window.windowNumber)
    }
